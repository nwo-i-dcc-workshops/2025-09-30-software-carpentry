...
humandate: "September 30 & October 2, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2025-10-02        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Leila Iñigo de la Cruz (4TU.ResearchData)", "Pieter Willem Groen (DIFFER)", "Tiernan O'Sullivan (Tilburg University)", "Jelle de Plaa (SRON)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
eventbrite: "1431611481479"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
...
<p id="recordings">
  ...
  To foster a positive learning environment, we only allow in-person participation for this workshop.
  As a result, workshop recordings will not be available to learners.
</p>
{% comment %}
